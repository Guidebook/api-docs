...
location_content_type  | yes | string  | Type of Object you want to link this survey to.  The options are: "schedule.session", "custom_list.customlistitem"
location_object_id     | yes | integer | Object ID of the object you want to associate this survey with.
notification_emails | no | list of emails  |  List of email addresses to notify when an answer is submmitted for this survey.
